...
var descriptionProject = "Il Database Group del <strong>Politecnico di Milano</strong>, <strong>Dipartimento di Elettronica, Informazione, e Bioingegneria</strong>, lo <strong>SKIL Lab di Telecom Italia</strong>  e <strong>LiveOn4G di TIM</strong> , attraverso tecnologie d'analisi d’avanguardia (<strong>streamreasoning.org</strong>) visualizzano graficamente in una nuova prospettiva l'andamento e l'intensità della conversazione su Twitter a Pescara durante il <strong>Festival delle Letterature</strong>. Questo servizio è parte del progetto City Data Fusion for Event Management finanziato dalla action line su  <strong>Urban Life and Mobility degli EIT ICT Labs</strong>.";
